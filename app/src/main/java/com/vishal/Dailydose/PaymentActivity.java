...
import com.vishal.Dailydose.ModelClass.Payment;
...
public class PaymentActivity extends AppCompatActivity {
    ...
    public static void placeOrder(final Context ctx){
        ...
        for (Cart cart : Utils.cartList) {
            final Order order = new Order(cart.getName(), cart.getImage(), cart.getPrice(), cart.getQuantity(), cart.getshop(), Utils.Address, "pending","paid");
